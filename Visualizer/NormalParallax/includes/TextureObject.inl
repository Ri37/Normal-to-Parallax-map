...
template<TextureType type>
inline TextureObject<type>::~TextureObject() noexcept
{
	Clean();
}

template<TextureType type>
inline TextureObject<type>::TextureObject(TextureObject&& rhs) noexcept :
	m_id(rhs.m_id)
{
	rhs.m_id = 0;
}
...
template<TextureType type>
inline TextureObject<type>& TextureObject<type>::operator=(TextureObject&& rhs) noexcept
{
	if (&rhs != this)
	{
		Clean();
...
template<TextureType type>
inline void TextureObject<type>::AttachFromFile(const std::string& filename, bool generateMipMap, GLuint role) const
{
...
template<TextureType type>
inline void TextureObject<type>::FromFile(const std::string& s) const
{
	AttachFromFile(s);
}
